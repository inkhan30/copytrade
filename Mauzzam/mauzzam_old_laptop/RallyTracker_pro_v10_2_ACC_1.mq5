//+------------------------------------------------------------------+
//| Expert Advisor: Dynamic Heding RallyTrackerPro_v10_2             |
//+------------------------------------------------------------------+
...
const long ALLOWED_ACCOUNT_NUMBERS[] = {183462175,270379723,183551573,128266726,159597159,413157344}; // Add your account numbers here
...
input int      RSI_Overbought      = 75;         // RSI overbought level (sell only above this)
input int      RSI_Oversold        = 35;         // RSI oversold level (buy only below this)
