...
input group "=== Trading Inputs ==="
   ...
   input int InpMagic               = 786786; // EA identification no
   input string   TradeComment      = "Scalping EA";
   ...
   int BarsN = 3;
   int ExpirationBars = 50;
   int OrderDistPoints = 30;
...
double findLow(){
   ...
   double low = iLow(_Symbol,Timeframe,i);
      if(i > BarsN && iHighest(_Symbol,Timeframe,MODE_LOW,BarsN*2+1,i-BarsN) == i){
         if(low < lowestLow){
            return low;
         }
      }
